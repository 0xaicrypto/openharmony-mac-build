...
OUT=obj/out/arm64_virt/obj/third_party/musl/intermidiates/linux/musl_src_ported/ldso/soft_musl_ldso_shared/dynlink.o
SRC=obj/third_party/musl/intermidiates/linux/musl_src_ported/ldso/dynlink.c
/opt/homebrew/bin/ccache $CLANG -MMD -MF "$OUT.d" $DEFINES $INCLUDE_DIRS $CFLAGS $CFLAGS_C -c "$SRC" -o "$OUT"
echo "dynlink.o compiled"
