...
OUT=obj/out/arm64_virt/obj/third_party/musl/intermidiates/linux/musl_src_ported/src/thread/soft_musl_src_shared/pthread_create.o
SRC=obj/third_party/musl/intermidiates/linux/musl_src_ported/src/thread/pthread_create.c
/opt/homebrew/bin/ccache $CLANG -MMD -MF "$OUT.d" $DEFINES $INCLUDE_DIRS $CFLAGS $CFLAGS_C -c "$SRC" -o "$OUT"
echo "pthread_create.o compiled"
