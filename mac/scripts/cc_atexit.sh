...
OUT=obj/out/arm64_virt/obj/third_party/musl/intermidiates/linux/musl_src_ported/src/exit/soft_musl_src_shared/atexit.o
SRC=obj/third_party/musl/intermidiates/linux/musl_src_ported/src/exit/atexit.c
/opt/homebrew/bin/ccache $CLANG -MMD -MF "$OUT.d" $DEFINES $INCLUDE_DIRS $CFLAGS $CFLAGS_C -c "$SRC" -o "$OUT"
echo "atexit.o compiled"
