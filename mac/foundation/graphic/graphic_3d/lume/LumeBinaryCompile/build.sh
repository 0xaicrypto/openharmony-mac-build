...
CMAKE_ROOT=$PROJECT_ROOT/prebuilts/cmake/darwin-universal/bin
echo $CMAKE_ROOT
 
OHOS_NDK=$PROJECT_ROOT/prebuilts/clang/ohos/darwin-arm64/llvm
LLVM_DIR=$PROJECT_ROOT/prebuilts/clang/ohos/darwin-arm64/llvm
echo $LLVM_DIR
 
NINJA_HOME=$PROJECT_ROOT/prebuilts/build-tools/darwin-x86/bin
echo $NINJA_HOME
