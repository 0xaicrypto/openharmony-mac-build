...
void PresetTypeDescriptors::InitDescriptors()
{
    ...
    typeDescriptors_.reserve(470);
    std::vector<TypeDescriptorCfg> more01 = {
        {"general.image",
         {"general.media"},
         {},
         {"image/*"},
    ...
    typeDescriptors_.insert(typeDescriptors_.end(), more01.begin(), more01.end());
    std::vector<TypeDescriptorCfg> more02 = {
    ...
    typeDescriptors_.insert(typeDescriptors_.end(), more02.begin(), more02.end());
    std::vector<TypeDescriptorCfg> more03 = {
    ...
    typeDescriptors_.insert(typeDescriptors_.end(), more03.begin(), more03.end());
    std::vector<TypeDescriptorCfg> more04 = {
    ...
    typeDescriptors_.insert(typeDescriptors_.end(), more04.begin(), more04.end());
    std::vector<TypeDescriptorCfg> more05 = {
        {"general.ota",
         {"general.audio"},
         {".ota"},
         {"audio/midi"},
    ...
    typeDescriptors_.insert(typeDescriptors_.end(), more05.begin(), more05.end());
    std::vector<TypeDescriptorCfg> more06 = {
    ...
    typeDescriptors_.insert(typeDescriptors_.end(), more06.begin(), more06.end());
    std::vector<TypeDescriptorCfg> more07 = {
        {"general.prn",
         {"general.composite-object"},
         {".prn"},
         {},
    ...
    typeDescriptors_.insert(typeDescriptors_.end(), more07.begin(), more07.end());
    std::vector<TypeDescriptorCfg> more08 = {
    ...
    typeDescriptors_.insert(typeDescriptors_.end(), more08.begin(), more08.end());
    std::vector<TypeDescriptorCfg> more09 = {
        {"com.sgi.movie",
         {"general.video"},
         {".movie"},
         {"video/x-sgi-movie"},
    ...
    typeDescriptors_.insert(typeDescriptors_.end(), more09.begin(), more09.end());
    std::vector<TypeDescriptorCfg> more10 = {
    ...
    typeDescriptors_.insert(typeDescriptors_.end(), more10.begin(), more10.end());
    std::vector<TypeDescriptorCfg> more11 = {
        {"com.autodesk.dws",
         {"general.composite-object"},
         {".dws"},
         {},
    ...
    typeDescriptors_.insert(typeDescriptors_.end(), more11.begin(), more11.end());
    std::vector<TypeDescriptorCfg> more12 = {
        {"com.microsoft.ini",
         {"general.text"},
         {".ini"},
         {},
    ...
    typeDescriptors_.insert(typeDescriptors_.end(), more12.begin(), more12.end());
    std::vector<TypeDescriptorCfg> more13 = {
    ...
    typeDescriptors_.insert(typeDescriptors_.end(), more13.begin(), more13.end());
    std::vector<TypeDescriptorCfg> more14 = {
        {"general.ogv",
         {"general.video"},
         {".ogv"},
         {"video/ogg"},
    ...
    typeDescriptors_.insert(typeDescriptors_.end(), more14.begin(), more14.end());
}
} // namespace UDMF
} // namespace OHOS
