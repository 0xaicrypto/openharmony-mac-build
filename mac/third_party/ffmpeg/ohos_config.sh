...
sed -i.bak 's/HAVE_SYSCTL 1/HAVE_SYSCTL 0/g' config.h
sed -i.bak 's/HAVE_SYSCTL=yes/!HAVE_SYSCTL=yes/g' ./ffbuild/config.mak
sed -i.bak 's/HAVE_GLOB 1/HAVE_GLOB 0/g' config.h
sed -i.bak 's/HAVE_GLOB=yes/!HAVE_GLOB=yes/g' config.h
sed -i.bak 's/HAVE_GMTIME_R 1/HAVE_GMTIME_R 0/g' config.h
sed -i.bak 's/HAVE_LOCALTIME_R 1/HAVE_LOCALTIME_R 0/g' config.h
sed -i.bak 's/HAVE_PTHREAD_CANCEL 1/HAVE_PTHREAD_CANCEL 0/g' config.h
sed -i.bak 's/HAVE_VALGRIND_VALGRIND_H 1/HAVE_VALGRIND_VALGRIND_H 0/g' config.h
...
sed -i.bak 's/restrict restrict/restrict /g' config.h

sed -i.bak '/getenv(x)/d' config.h
sed -i.bak 's/HAVE_DOS_PATHS 0/HAVE_DOS_PATHS 1/g' config.h
